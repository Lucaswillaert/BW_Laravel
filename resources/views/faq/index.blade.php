                            ...
                            <div class="post-container mx-auto bg-white rounded shadow-md mt-6 px-4 py-4 w-1/2">
                                <section id="about-us">
                                    <form action="{{ route('faq.store') }}" method="POST"
                                        ...
                                        @csrf
                                        <textarea name="question" class="description bg-gray-100 sec p-3 h-60 border border-gray-300 outline-none w-full"
                                            spellcheck="false" placeholder="ask us any question you want to know" required></textarea>
